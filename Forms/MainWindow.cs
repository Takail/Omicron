...
namespace Omicron_Pi
{
    public partial class OmicronPiMainWindow : Form
    {
        ...
        public OmicronPiMainWindow()
        {
            InitializeComponent();
            tabControlMethod();
            if (Launcher.remoteAdmConfigPath != null)
                initialize(Launcher.remoteAdmConfigPath);
        }

        /// <summary>
        /// Adds the different tab pages to the savedTabPages (Previously was used in From1_Shown)
        /// </summary>
        ...
        #region Save, restart and close button methods
        ...
        private void saveCFGButton_Click(object sender, EventArgs e)
        {
            ...
            if (configFilePath == userPath + @"\AppData\LocalLow\Omicron\temp_config_DO_NOT_EDIT_THIS_FILE.txt")
            {
        ...
        {
            Launcher.remoteAdmConfigPath = configFilePath;
        ...
        private void OmicronPiMainWindow_FormClosing(object sender, FormClosingEventArgs e)
        {
